# Document 36: alani-security: API
...
Security primitive APIs for auth, crypto, and capabilities.

This api document for alani-security provides implementation-ready guidance for Rust developers. Specify auth, authorization, key, and cryptographic primitive APIs.
...
- Primary aspects: Capability, PolicyEngine, CryptoProvider, KeyHandle.
...
- ALANI-D36-REQ-01: alani-security MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D36-REQ-02: alani-security MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D36-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D36-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D36-AC-01: A developer can create alani-security from the provided template and understand its first implementation tasks.
- ALANI-D36-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D36-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D36-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D36-02: Path dependencies in templates must be adjusted when repositories are published independently.
