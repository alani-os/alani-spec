# Document 61: Contribution Guidelines
...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-61 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Contributors |
| Depends on | Doc 47, Doc 49 |

## Purpose

External and internal contribution procedure.

Contribution guidelines define contributor onboarding, issues, PRs, code of conduct reference, and maintainer responsibilities.
...
- ALANI-D61-REQ-01: The document MUST cover: setup, issue flow, PR flow, reviews, governance.
- ALANI-D61-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D61-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D61-REQ-04: Security and audit implications MUST be considered before release.
...
- ALANI-D61-AC-01: A contributor can perform the procedure without private context.
- ALANI-D61-AC-02: The document names failure modes and how to recover.
- ALANI-D61-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D61-01: Manual process steps can diverge from automation.
- RISK-D61-02: Legal and data-source assumptions require human review before external publication.
...
| Doc 49 | Must be read before implementing this document. |
