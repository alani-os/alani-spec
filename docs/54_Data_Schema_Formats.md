# Document 54: Data Schema & Formats
...
Corpus schema definitions and file formats.

Data schema and formats specify JSONL records, schema files, splits, and metadata conventions.
...
- ALANI-D54-REQ-01: The document MUST cover: record fields, annotations, splits, schema validation, versioning.
- ALANI-D54-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D54-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D54-REQ-04: Security and audit implications MUST be considered before release.
...
```json
{
  "record_id": "alani-synth-000001",
  "schema_version": "alani.corpus.v1",
  "split": "train",
  "source": { "kind": "synthetic", "license": "internal-draft", "generator": "generate_synthetic_corpus.py" },
  "task": "terminal_command",
  "input": { "text": "Show the last five audit denials." },
  "expected": { "action": "audit.query", "arguments": { "decision": "deny", "limit": 5 } },
  "labels": ["terminal", "audit", "query"],
  "annotations": { "intent": "audit_query", "safety_class": "internal", "priority": "normal" }
}
```

## Acceptance Criteria

- ALANI-D54-AC-01: A contributor can perform the procedure without private context.
- ALANI-D54-AC-02: The document names failure modes and how to recover.
- ALANI-D54-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D54-01: Manual process steps can diverge from automation.
- RISK-D54-02: Legal and data-source assumptions require human review before external publication.
...
| Dependency | Reason |
|---|---|
| Doc 53 | Must be read before implementing this document. |
