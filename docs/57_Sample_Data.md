...
Examples of corpus records and expected annotations.

Sample data provides concrete JSONL examples for developers and tests.
...
- ALANI-D57-REQ-01: The document MUST cover: sample records, positive examples, negative examples, edge cases, fixtures.
- ALANI-D57-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D57-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D57-REQ-04: Security and audit implications MUST be considered before release.
...
- ALANI-D57-AC-01: A contributor can perform the procedure without private context.
- ALANI-D57-AC-02: The document names failure modes and how to recover.
- ALANI-D57-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D57-01: Manual process steps can diverge from automation.
- RISK-D57-02: Legal and data-source assumptions require human review before external publication.
