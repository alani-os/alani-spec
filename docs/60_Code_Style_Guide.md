...
Rust formatting, idioms, naming, module organization, and unsafe rules.

Code style guide defines Rust formatting, linting, naming, unsafe usage, module layout, and error handling.
...
- ALANI-D60-REQ-01: The document MUST cover: rustfmt, clippy, naming, unsafe, errors, docs.
- ALANI-D60-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D60-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D60-REQ-04: Security and audit implications MUST be considered before release.
...
pub use error::{AlaniError, Result};

/// Public item docs explain purpose, errors, safety, and examples.
pub trait KernelApi {
    fn sys_info(&self) -> Result<AbiVersion>;
}
```

## Acceptance Criteria

- ALANI-D60-AC-01: A contributor can perform the procedure without private context.
- ALANI-D60-AC-02: The document names failure modes and how to recover.
- ALANI-D60-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D60-01: Manual process steps can diverge from automation.
- RISK-D60-02: Legal and data-source assumptions require human review before external publication.
