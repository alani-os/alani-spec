# Document 37: alani-audit: README
...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-37 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Security and audit developers |
| Depends on | Doc 17 |

## Purpose

Audit repository overview and integration guidance.

This readme document for alani-audit provides implementation-ready guidance for Rust developers. Provide append-only audit events and hash-chain storage.
...
- Primary aspects: events, segments, verification, export.
...
- ALANI-D37-REQ-01: alani-audit MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D37-REQ-02: alani-audit MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D37-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D37-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D37-AC-01: A developer can create alani-audit from the provided template and understand its first implementation tasks.
- ALANI-D37-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D37-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D37-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D37-02: Path dependencies in templates must be adjusted when repositories are published independently.
