# Document 41: alani-userspace: README
...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-41 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Userspace developers |
| Depends on | Doc 5, Doc 19 |

## Purpose

Example userspace application repository overview.

This readme document for alani-userspace provides implementation-ready guidance for Rust developers. Provide example userspace agents and applications.
...
- Primary aspects: hello agent, memory demo, cognition demo, audit demo.
...
- alani-userspace owns its public crate boundary and README examples.
...
- ALANI-D41-REQ-01: alani-userspace MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D41-REQ-02: alani-userspace MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D41-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D41-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- alani-userspace/Cargo.toml
- alani-userspace/src/lib.rs or src/main.rs
- alani-userspace/tests
- alani-userspace/.github/workflows/ci.yml
...
- ALANI-D41-AC-01: A developer can create alani-userspace from the provided template and understand its first implementation tasks.
- ALANI-D41-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D41-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D41-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D41-02: Path dependencies in templates must be adjusted when repositories are published independently.
