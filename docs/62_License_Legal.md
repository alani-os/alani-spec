...
License, warranty, trademark, data, and legal review requirements.

License and legal specifies the draft licensing posture, third-party notices, trademarks, data rights, and legal review gates.
...
- ALANI-D62-REQ-01: The document MUST cover: license, copyright, trademark, data rights, warranty, review.
- ALANI-D62-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D62-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D62-REQ-04: Security and audit implications MUST be considered before release.
...
- The bundle includes LICENSE-DRAFT as a placeholder. It is not legal advice and must be reviewed before publication.
- If the project chooses MIT/Apache-2.0 dual licensing instead of a custom Dust Open Source License, update Cargo manifests, SPDX headers, and repository READMEs.
- Corpus licensing must be tracked per record; no dataset can enter release artifacts without license and provenance metadata.
...
- ALANI-D62-AC-01: A contributor can perform the procedure without private context.
- ALANI-D62-AC-02: The document names failure modes and how to recover.
- ALANI-D62-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D62-01: Manual process steps can diverge from automation.
- RISK-D62-02: Legal and data-source assumptions require human review before external publication.
