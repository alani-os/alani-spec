...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-34 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Driver developers |
| Depends on | Doc 13 |

## Purpose

Device driver trait and helper API specification.

This api document for alani-devices provides implementation-ready guidance for Rust developers. Specify driver traits, lifecycle, and operation envelopes.
...
- Primary aspects: Device trait, DeviceOp, interrupts, DMA buffers.
...
- alani-devices owns its public crate boundary and README examples.
...
- ALANI-D34-REQ-01: alani-devices MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D34-REQ-02: alani-devices MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D34-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D34-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- alani-devices/Cargo.toml
- alani-devices/src/lib.rs or src/main.rs
- alani-devices/tests
- alani-devices/.github/workflows/ci.yml
...
- ALANI-D34-AC-01: A developer can create alani-devices from the provided template and understand its first implementation tasks.
- ALANI-D34-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D34-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D34-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D34-02: Path dependencies in templates must be adjusted when repositories are published independently.
