# Document 49: Code Review Guidelines
...
Review checklist, approval criteria, and required checks.

Code review guidelines define what reviewers must check before approving changes.
...
- ALANI-D49-REQ-01: The document MUST cover: correctness, security, API stability, tests, documentation.
- ALANI-D49-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D49-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D49-REQ-04: Security and audit implications MUST be considered before release.
...
- ALANI-D49-AC-01: A contributor can perform the procedure without private context.
- ALANI-D49-AC-02: The document names failure modes and how to recover.
- ALANI-D49-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D49-01: Manual process steps can diverge from automation.
- RISK-D49-02: Legal and data-source assumptions require human review before external publication.
