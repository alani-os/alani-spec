# Document 29: alani-cognition: README
...
Cognitive engine repository overview.

This readme document for alani-cognition provides implementation-ready guidance for Rust developers. Provide model execution and cognitive service entry points.
...
- Primary aspects: model registry, inference API, memory retrieval, budgeting.
...
- ALANI-D29-REQ-01: alani-cognition MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D29-REQ-02: alani-cognition MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D29-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D29-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D29-AC-01: A developer can create alani-cognition from the provided template and understand its first implementation tasks.
- ALANI-D29-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D29-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D29-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D29-02: Path dependencies in templates must be adjusted when repositories are published independently.
