...
Reusable templates for specifications, ADRs, RFCs, and API docs.

Documentation templates define consistent document structure for specs, ADRs, RFCs, API references, and runbooks.
...
- ALANI-D59-REQ-01: The document MUST cover: spec template, ADR template, RFC template, API template, runbook template.
- ALANI-D59-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D59-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D59-REQ-04: Security and audit implications MUST be considered before release.
...
- ALANI-D59-AC-01: A contributor can perform the procedure without private context.
- ALANI-D59-AC-02: The document names failure modes and how to recover.
- ALANI-D59-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D59-01: Manual process steps can diverge from automation.
- RISK-D59-02: Legal and data-source assumptions require human review before external publication.
