...
Permitted data sources, provenance, licensing, and intake rules.

Data sources specify permitted, prohibited, and conditional sources for the Alani corpus.
...
- ALANI-D53-REQ-01: The document MUST cover: synthetic data, open datasets, logs, license review, provenance.
- ALANI-D53-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D53-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D53-REQ-04: Security and audit implications MUST be considered before release.
...
- ALANI-D53-AC-01: A contributor can perform the procedure without private context.
- ALANI-D53-AC-02: The document names failure modes and how to recover.
- ALANI-D53-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D53-01: Manual process steps can diverge from automation.
- RISK-D53-02: Legal and data-source assumptions require human review before external publication.
