# Document 25: alani-runtime: README
...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-25 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Runtime developers |
| Depends on | Doc 6, Doc 8 |

## Purpose

Runtime repository overview, setup, and usage.

This readme document for alani-runtime provides implementation-ready guidance for Rust developers. Run the userspace init/runtime layer and host-mode mocks.
...
- Primary aspects: agent loading, syscall wrappers, manifest parsing, mock kernel.
...
- ALANI-D25-REQ-01: alani-runtime MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D25-REQ-02: alani-runtime MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D25-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D25-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D25-AC-01: A developer can create alani-runtime from the provided template and understand its first implementation tasks.
- ALANI-D25-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D25-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D25-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D25-02: Path dependencies in templates must be adjusted when repositories are published independently.
