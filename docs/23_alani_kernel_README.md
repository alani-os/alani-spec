# Document 23: alani-kernel: README
...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-23 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Kernel developers, integrators |
| Depends on | Doc 1, Doc 6 |

## Purpose

Developer-facing setup and build instructions for the kernel repository.

This readme document for alani-kernel provides implementation-ready guidance for Rust developers. Build, run, and test the bare-metal kernel skeleton.
...
- Primary aspects: boot, arch, memory, scheduler, syscall, devices, security, audit.
...
- ALANI-D23-REQ-01: alani-kernel MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D23-REQ-02: alani-kernel MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D23-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D23-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D23-AC-01: A developer can create alani-kernel from the provided template and understand its first implementation tasks.
- ALANI-D23-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D23-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D23-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D23-02: Path dependencies in templates must be adjusted when repositories are published independently.
