...
Coverage, linting, fuzzing, static analysis, and QA gates.

Quality assurance defines non-functional gates that protect correctness, security, style, and maintainability.
...
- ALANI-D46-REQ-01: The document MUST cover: format, clippy, coverage, MIRI where possible, dependency audit.
- ALANI-D46-REQ-02: Procedures MUST be reproducible from a clean checkout or clean artifact bundle.
- ALANI-D46-REQ-03: Inputs, outputs, owners, and approval gates MUST be named.
- ALANI-D46-REQ-04: Security and audit implications MUST be considered before release.
...
- ALANI-D46-AC-01: A contributor can perform the procedure without private context.
- ALANI-D46-AC-02: The document names failure modes and how to recover.
- ALANI-D46-AC-03: The procedure can be mapped to CI or release evidence.
...
- RISK-D46-01: Manual process steps can diverge from automation.
- RISK-D46-02: Legal and data-source assumptions require human review before external publication.
