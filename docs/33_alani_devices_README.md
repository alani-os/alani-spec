# Document 33: alani-devices: README
...
Device repository overview and device class support.

This readme document for alani-devices provides implementation-ready guidance for Rust developers. Define device abstractions and mock devices.
...
- Primary aspects: device classes, registry, mocks, driver examples.
...
- ALANI-D33-REQ-01: alani-devices MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D33-REQ-02: alani-devices MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D33-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D33-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D33-AC-01: A developer can create alani-devices from the provided template and understand its first implementation tasks.
- ALANI-D33-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D33-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D33-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D33-02: Path dependencies in templates must be adjusted when repositories are published independently.
