# Document 31: alani-memory: README
...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-31 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Memory developers |
| Depends on | Doc 11 |

## Purpose

Persistent and cognitive memory repository overview.

This readme document for alani-memory provides implementation-ready guidance for Rust developers. Implement persistent cognitive memory and host-mode stores.
...
- Primary aspects: record storage, vector metadata, snapshots, mock NVM.
...
- alani-memory owns its public crate boundary and README examples.
...
- ALANI-D31-REQ-01: alani-memory MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D31-REQ-02: alani-memory MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D31-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D31-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- alani-memory/Cargo.toml
- alani-memory/src/lib.rs or src/main.rs
- alani-memory/tests
- alani-memory/.github/workflows/ci.yml
...
- ALANI-D31-AC-01: A developer can create alani-memory from the provided template and understand its first implementation tasks.
- ALANI-D31-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D31-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D31-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D31-02: Path dependencies in templates must be adjusted when repositories are published independently.
