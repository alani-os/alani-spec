...
Public Rust API specification for shared types and helpers.

This api document for alani-lib provides implementation-ready guidance for Rust developers. Specify public Rust modules shared across repositories.
...
- Primary aspects: abi module, syscall module, capability types, trace types.
...
- alani-lib owns its public crate boundary and README examples.
...
- ALANI-D28-REQ-01: alani-lib MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D28-REQ-02: alani-lib MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D28-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D28-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- alani-lib/Cargo.toml
- alani-lib/src/lib.rs or src/main.rs
- alani-lib/tests
- alani-lib/.github/workflows/ci.yml
...
- ALANI-D28-AC-01: A developer can create alani-lib from the provided template and understand its first implementation tasks.
- ALANI-D28-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D28-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D28-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D28-02: Path dependencies in templates must be adjusted when repositories are published independently.
