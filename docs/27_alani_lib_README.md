...
Shared library repository overview.

This readme document for alani-lib provides implementation-ready guidance for Rust developers. Provide shared ABI types, utility functions, and safe syscall wrappers.
...
- Primary aspects: abi, syscall wrappers, result types, feature flags.
...
- ALANI-D27-REQ-01: alani-lib MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D27-REQ-02: alani-lib MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D27-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D27-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- ALANI-D27-AC-01: A developer can create alani-lib from the provided template and understand its first implementation tasks.
- ALANI-D27-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D27-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D27-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D27-02: Path dependencies in templates must be adjusted when repositories are published independently.
