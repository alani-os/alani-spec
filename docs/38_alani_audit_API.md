...
|---|---|
| Project | Alani |
| Document ID | ALANI-SPEC-38 |
| Status | Draft implementation specification |
| Version | 0.1.0-draft |
| Generated | 2026-04-30T21:27:04Z |
| Audience | Audit developers |
| Depends on | Doc 17, Doc 18 |

## Purpose

Audit log, query, and integrity API specification.

This api document for alani-audit provides implementation-ready guidance for Rust developers. Specify audit event, sink, query, and proof APIs.
...
- Primary aspects: AuditEvent, AuditSink, AuditQuery, AuditProof.
...
- alani-audit owns its public crate boundary and README examples.
...
- ALANI-D38-REQ-01: alani-audit MUST build independently where possible and MUST document sibling repository requirements.
- ALANI-D38-REQ-02: alani-audit MUST expose only the APIs named in this document until an RFC expands them.
- ALANI-D38-REQ-03: Every public item MUST include rustdoc explaining safety, errors, and examples.
- ALANI-D38-REQ-04: Every repository MUST include README, Cargo.toml, src, tests, and CI workflow files.
...
- alani-audit/Cargo.toml
- alani-audit/src/lib.rs or src/main.rs
- alani-audit/tests
- alani-audit/.github/workflows/ci.yml
...
- ALANI-D38-AC-01: A developer can create alani-audit from the provided template and understand its first implementation tasks.
- ALANI-D38-AC-02: README commands are copy-pasteable after repositories are placed as siblings.
- ALANI-D38-AC-03: Public APIs are traceable to an architecture or data-format document.
...
- RISK-D38-01: Repository drift can occur if shared interfaces are duplicated without tests.
- RISK-D38-02: Path dependencies in templates must be adjusted when repositories are published independently.
...
| Doc 18 | Must be read before implementing this document. |
